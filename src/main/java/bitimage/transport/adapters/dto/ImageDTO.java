...
public class ImageDTO {
  ...
  @Pattern(regexp = RegexPatterns.HASH_MD5, message = "Image hash must be a valid MD5 hash")
  public String hash;

  @NotNull(message = "Image privacy status cannot be null")
  @Pattern(regexp = RegexPatterns.BOOLEAN, message = "Image privacy status must be true or false")
